...
<div class="jh_error_pic500">
	...
	<div class="jh_t_mar01 jh_error_500Content">
		...
		<%} %>
		<form action='mailto:n-support@lashou-inc.com'>
			<input name='cc' type='hidden' value='yunwei_group@lashou-inc.com'/>
			<input name='subject' type='hidden' value='[<%=statusCode%>]n.lashou.com异常错误' />
